...
import com.company.sak.hw3.task1.exception.OutOfBoundException;
...
public class ArrayService{
    ...
    public static void bubbleSort(Array currentArray) throws NullException, OutOfBoundException {
    ...
    public static void insertionSort(Array currentArray) throws NullException, OutOfBoundException {
        if (currentArray == null){
            throw new NullException();
        }
    ...
    public static void selectionSort(Array currentArray) throws NullException, OutOfBoundException{
        if (currentArray == null){
            throw new NullException();
        }
    ...
    public static int binarySearch(Array currentArray, int elementToSearch) throws NullException {
        if (currentArray == null){
            throw new NullException();
        }
        int firstElement = 0;
    ...
    public static int findMax(Array currentArray) throws NullException {
        if (currentArray == null){
            throw new NullException();
        }
    ...
    public static int findMin(Array currentArray) throws NullException {
        if (currentArray == null){
            throw new NullException();
        }
    ...
    public static int[] findPrimeNumber(Array currentArray) throws NullException {
        if (currentArray == null){
            throw new NullException();
        }
    ...
    public static int[] fibonacciNumbers(Array currentArray) throws NullException {
        if (currentArray == null){
            throw new NullException();
        }
        List<Integer> arrayCopy = new ArrayList();
    ...
    public static int[] findDigitsNumbers(Array currentArray) throws NullException {
        if (currentArray == null){
            throw new NullException();
        }
        List<Integer> arrayCopy = new ArrayList();
        int value;
        for (int i = 0; i < currentArray.getCapacity(); i++) {
            value = Math.abs(currentArray.get(i));
